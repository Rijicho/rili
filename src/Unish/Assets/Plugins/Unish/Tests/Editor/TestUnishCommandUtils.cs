...
public class TestUnishCommandUtils
{
    ...
    [Test]
    public void _0_ParseVariables([ValueSource(nameof(tcParseVariables))] (string input, string want) tc)
    {
        var (input, want) = tc;
    ...
    private static (string input, (string, UnishCommandTokenType)[] want)[] tc2 =
    {
        ...
        {
            ("hoge", UnishCommandTokenType.Param),
            ("a", UnishCommandTokenType.OptionShort),
            ("fuga", UnishCommandTokenType.Param),
            ("bbb", UnishCommandTokenType.OptionLong),
        }),
